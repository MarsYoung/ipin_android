...
public abstract class QuickActionWidget extends PopupWindow {
	...
	private void initializeDefault() {
		...
		this.mArrowOffsetY = this.mContext.getResources()
				.getDimensionPixelSize(R.dimen.arrow_offset);
	}
	...
	public void setContentView(int paramInt) {
		setContentView(LayoutInflater.from(this.mContext).inflate(paramInt,
				null));
	}
	...
	public void setOnQuickActionClickListener(
			OnQuickActionClickListener paramOnQuickActionClickListener) {
	...
	public void show(View paramView) {
		...
		this.mRect.set(arrayOfInt[0], arrayOfInt[1],
		...
		if ((0x2 & this.mPrivateFlags) != 2)
			throw new IllegalStateException(
					"onMeasureAndLayout() did not set the widget specification by calling setWidgetSpecs()");
		showArrow();
	...
	public static abstract interface OnQuickActionClickListener {
		public abstract void onQuickActionClicked(
